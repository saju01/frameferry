...
function profilePaths(root, handle) {
  ...
  return {
    root,
    stateDir: path.join(root, '.instacognito', handle),
    ...
    manifest: path.join(root, '.instacognito', handle, 'manifest.json'),
    status: path.join(root, '.instacognito', handle, 'status.json')
  };
}
